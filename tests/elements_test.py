...
from pages.interactions_page import ResizablePage, DroppablePage
...
class TestElements:
    class TestTextBox:
        ...
        def test_text_box(self, driver):
            ...
            assert input_data == output_data, "the elements does not match"
    ...
    class TestWebTable:
        ...
        def test_web_table_search_person(self, driver):
            ...
            table_result = web_table_page.check_search_people()
        ...
        def test_web_table_update_person_info(self, driver):
            ...
            row = web_table_page.check_search_people()
    ...
    class TestLinksPage:
        ...
        def test_check_link(self, driver):
            ...
            assert href_link == current_url, "the link is broken or url us incorrect"
...
class TestUploadAnDownload:
    def test_upload_file(self, driver):
        upload_download_page = UploadAnDownloadPage(driver, "https://demoqa.com/upload-download")
...
class TestDroppablePage:
    ...
    def test_prevent_propogation_droppable(self, driver):
        ...
        assert greedy_inner == 'Dropped!', 'the elements texts has been changed'
